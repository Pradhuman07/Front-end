const users = [
    ...
    },
    {
      ...
      description: "Artist showcasing creativity through artworks and sketches.",
...
users.forEach(function(elem){
    cardss += `    <div class="card">
        <img class="coverPhoto" src=${elem.coverPhoto} alt="">

        <br>

        <img class="profilePhoto" src=${elem.profilePhoto} alt="">

        <h1 id="username">${elem.username}</h1>
        <h2 id="fullname">${elem.fullName}</h2>
